...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount_amount: @discount.discount_amount, discount_name: @discount.discount_name, discount_percent: @discount.discount_percent, end: @discount.end, product_id: @discount.product_id, start: @discount.start } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount_amount: @discount.discount_amount, discount_name: @discount.discount_name, discount_percent: @discount.discount_percent, end: @discount.end, product_id: @discount.product_id, start: @discount.start } }
